...
public class DBUtils {
    ...
    public static void createConnection() {
        String dbUrl = ConfigurationReader.getProperty("spartan.url");
        String dbUsername = ConfigurationReader.getProperty("spartan.database.username");
        String dbPassword = ConfigurationReader.getProperty("spartan.database.password");
        try {
